...
قواعد صارمة لاسم النبات (plantName):
- اكتب الاسم العربي الشائع المعروف عند عامة الناس والمزارعين
- أمثلة صحيحة: طماطم، مانجو، نخيل، زيتون، قمح، ذرة، بطاطس، فلفل، باذنجان، خيار، كوسا، بصل، ثوم، ليمون، برتقال، تفاح، رمان، عنب، موز، فراولة، ورد، ياسمين، صبار، نعناع، ريحان، جوافة، تين، رمان، توت، كرز، خوخ، مشمش، جوز، لوز، كاكاو، قهوة، شاي، قصب السكر، بطيخ، شمام، قرع، لوبيا، فول، عدس، حمص، أرز، شعير، سمسم، عباد الشمس، فول السوداني
- لا تستخدم الأسماء العلمية اللاتينية أبداً
- لا تستخدم أسماء غير مألوفة أو محلية ضيقة
- إذا كان نبات زينة داخلي اكتب مثل: فيكس، بوتس، سانسيفيريا، كروتون، نبتة المطاط
- إذا لم تعرف النوع بدقة اكتب الفصيلة العامة مثل: شجرة نخيل، شجرة حمضيات، نبات شوكي، عشبة خضراء
